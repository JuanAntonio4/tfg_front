export default {
    ...
    validate: function (trabajo_realizado_obra, materialesUsados) {
        let errores = [];

        let descripcionTrabajoRealizado = trabajo_realizado_obra.descripcion_trabajo_realizado;
        let observaciones = trabajo_realizado_obra.observaciones;
        let fecha = trabajo_realizado_obra.fecha_atencion;
        let horas = trabajo_realizado_obra.horas_invertidas;


        if (descripcionTrabajoRealizado === ""  || fecha === "" || horas === "") {
        ...
        if (horas < 0) {
            ...
            errores.push("No se pueden introducir horas negativas")
